...
<?php
	...
	include("../connect.php");
	$query="select * from tbl_patient order by date desc";
		...
		<div class="container-fluid contents">
			<table class="table table-striped bg-warning">
				...
				<tr>
					...
					<td><a href="delp.php?pid=<?php echo $row['pat_id'] ?>"><i class="fas fa-trash-alt"></i></a></td>
				</tr>
				<?php
				$a++;
				}
			...
			<h1 class="text-center">Total Patients :  <?php echo $a-1; ?></h1>
		</div>
	</div>
</body>
</html>
